  ...
  return (
    <main className="font-serif mb-24">
      <div className="relative w-screen h-screen flex items-center justify-center bg-black/30">
        <Image
          src="/bryllup/bridal-girl-flowers.jpg"
      ...
      <div className="px-6 py-12 lg:pt-32 max-w-7xl mx-auto text-center">
      ...
      <div className="flex justify-center pb-32">
        <Button target="_blank" type="link" size="large" href="/bryllup/katalog-2026.pdf" className="underline! p-0!">
          Se vår bryllupskatalog
        </Button>
      </div>
      ...
      <div className="mt-24 lg:mt-32 mx-12 flex flex-col items-center">
        <div className="flex flex-col lg:flex-row lg:justify-between lg:gap-80 items-center max-w-5xl">
          <Image
            src="/bryllup/logo-gold-crop.png"
            alt=""
            width={500}
            height={500}
          ...
          />
          <Image
            src="/bryllup/bryllup-detaljer.jpg"
            alt=""
            width={500}
            height={500}
